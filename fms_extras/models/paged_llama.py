...
from fms_extras.modules.positions import RotaryEmbeddingContiguous
...
class PagedLLaMABlock(nn.Module):
    def __init__(self, config: PagedLLaMAConfig, rotary_emb: RotaryEmbeddingContiguous):
...
class PagedLLaMA(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.rot_emb = RotaryEmbeddingContiguous(
